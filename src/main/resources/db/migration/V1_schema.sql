...
CREATE TABLE IF NOT EXISTS faculty (
	...
	CONSTRAINT fk_facity_university FOREIGN KEY (university_id) REFERENCES university (id)
);
...
CREATE TABLE IF NOT EXISTS lesson (
	...
	CONSTRAINT fk_lesson_room FOREIGN KEY (room_id) REFERENCES room (id) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS student (
	...
	groupe_id UUID,
	CONSTRAINT fk_student_user FOREIGN KEY (user_id) REFERENCES userr (id),
	CONSTRAINT fk_student_groupe FOREIGN KEY (groupe_id) REFERENCES groupe (id)
);
...
CREATE TABLE IF NOT EXISTS teacher (
	...
	user_id UUID UNIQUE NOT NULL,
	department_id UUID,
	CONSTRAINT fk_teacher_user FOREIGN KEY (user_id) REFERENCES userr (id),
